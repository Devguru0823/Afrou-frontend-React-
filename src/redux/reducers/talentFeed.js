import {
  SET_TALENT_FEED, UPDATE_TALENT_FEED_COMMENT,
  UPDATE_TALENT_FEED, UPDATE_TALENT_FEED_TEXT,
  UPDATE_TALENT_FEED_DELETE, CLEAR_TALENT_FEED,
  UPDATE_TALENT_FEED_COMMENT_LIKE, UPDATE_TALENT_FEED_COMMENT_REPLY,
  UPDATE_TALENT_COMMENT_MANIPULATE, UPDATE_TALENT_FOLLOW
...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case UPDATE_TALENT_FEED:
      ...
      return state;
    case UPDATE_TALENT_FEED_COMMENT:
      ...
      return state;
    case UPDATE_TALENT_FEED_COMMENT_REPLY:
      ...
      return state;
    case UPDATE_TALENT_FEED_COMMENT_LIKE:
    ...
    case UPDATE_TALENT_FEED_DELETE:
    ...
    case UPDATE_TALENT_COMMENT_MANIPULATE:
