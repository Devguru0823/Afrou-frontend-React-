...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case UPDATE_SWAGGER_FEED:
      ...
      return state;
    case UPDATE_SWAGGER_FEED_COMMENT:
      ...
      return state;
    case UPDATE_SWAGGER_FEED_COMMENT_REPLY:
      ...
      return state;
    case UPDATE_SWAGGER_FEED_COMMENT_LIKE:
    ...
    case UPDATE_SWAGGER_FEED_DELETE:
    ...
    case UPDATE_SWAGGER_COMMENT_MANIPULATE:
