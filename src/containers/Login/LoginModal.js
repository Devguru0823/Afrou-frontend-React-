...
const controls = {
	...
	countryTelephoneCode: {
		...
		onlyOuterClassName: 'col-12 logcountry pl-0',
	},
	email: {
		elementType: 'input',
		elementConfig: {
      ...
      'data-for': 'emailOrPhone'*/
		...
		valid: false,
		touched: false,
		outerClassName: 'col-12 loguser pl-0',
	},
	password: {
		elementType: 'input',
		elementConfig: {
		...
		valid: false,
		touched: false,
		outerClassName: 'col-12 logpass pl-0',
	},
};
...
class LoginModal extends Component {
	...
	render() {
		if (
			...
			this.props.location.state === '/ehealth'
		) {
			window.location.href = `/ehealth?page=2&price=${this.props.price}&plan_id=${this.props.plan._id}&currency=${this.props.plan.currency}&country=${this.props.plan.country}`;
		}
